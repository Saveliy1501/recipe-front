                ...
                <div className="w-full grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
                  <div className="sm:col-span-4 lg:col-span-5">
                    <div className="aspect-w-1 aspect-h-1 rounded-lg bg-gray-100 overflow-hidden">
                      <img src={recipe.picture} alt="" className="w-full h-full" />
                    </div>
                  </div>
                  <div className="sm:col-span-8 lg:col-span-7">
                    ...
                    <section aria-labelledby="options-heading" className="mt-2">
                      <div className="flex sm:flex-col1">
                        ...
                        >
                          <BookmarkIcon
                            className={`h-6 w-6 transition-colors ${savedRecipes[id] ? "text-teal-500 fill-current" : ""}`}
                            aria-hidden="true"
                          />
                        ...
                        >
                          <HeartIcon
                            className={`h-6 w-6 transition-colors ${likedRecipes[id] ? "text-red-500 fill-current" : ""}`}
                            aria-hidden="true"
                          />
                      ...
                      <div className="flex justify-between">
                        ...
                        <p className="mt-8 text-sm font-weight text-gray-500 truncate">by {recipe.username}</p>
                      </div>
